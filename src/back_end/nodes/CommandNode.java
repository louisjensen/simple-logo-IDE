...
public abstract class CommandNode {
    ...
    /**
     * returns list of this Node's children - these will be used as arguments to evaluate a back_end.nodes.CommandNode
     */
    protected List<CommandNode> getChildren(){
        return myChildren;
    }
    /**
     * adds a back_end.nodes.CommandNode to this back_end.nodes.CommandNode's list of children
     */
